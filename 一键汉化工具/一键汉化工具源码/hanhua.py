...
def create_main_window():
    ...
    CTkLabel(input_frame, text="输入汉化包名(需在同目录):", font=("Microsoft YaHei", 16)).pack(side=ctk.LEFT, padx=5)
    CTkEntry(input_frame, textvariable=locale_var, width=100, font=("Microsoft YaHei", 16, "bold"), text_color="#FF9166").pack(side=ctk.LEFT, padx=5)
